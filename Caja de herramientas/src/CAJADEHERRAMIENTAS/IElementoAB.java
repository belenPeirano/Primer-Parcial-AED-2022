...
public interface IElementoAB<T> {
    ...
    /**
     * En el caso de que exista un elemento con etiqueta igual a la indicada, será eliminado, al ser sustituido por
     * el elemento con etiqueta mayor de su subárbol izquierdo.
     * @param unaEtiqueta
     * @return
     */
